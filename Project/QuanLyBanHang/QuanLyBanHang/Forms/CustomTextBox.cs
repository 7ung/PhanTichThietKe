...
namespace WindowsFormsControlLibrary
{
    ...
    public partial class CustomTextBox : UserControl
    {
        ...
        private void CustomTextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            if (this.Text == "")
            {
                if (this.isRequired)
                {
                    ...
                    balloonToolTip.Show("Bắt buộc!", textBox, new Point(textBox.Width / 2, textBox.Height / 2), 2000);
        ...
        public bool CheckCodition()
        {
            ...
            if (this.StringPattern == null || this.StringPattern == "")
            {
        ...
        private void CustomTextBox_Load(object sender, EventArgs e)
        {
            ...
            //this.Parent.Closing += ParentFormOnClosing;
        ...
        /// <summary>
        /// Reset lại trạng thái của control
        /// </summary>
